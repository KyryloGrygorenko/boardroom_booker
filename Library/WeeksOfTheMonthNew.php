...
abstract class WeeksOfTheMonthNew
{
    ...
    public static function GetWeeksOfTheMonth($days_in_month,$days_mode,$first_day_of_the_month,$unix_day){
            ...
            foreach ($days_mode as $day){
                ...
                if($day == $first_day_of_the_month || (isset($current_day) && $current_day>1) ){
                    ...
                    if($current_day <= $days_in_month){
                        ...
                        self::$days_objects_by_week[$i][$current_day]=$current_day;
...
//    public static function setUnixDate($unix_day,){
//        self::$all_unix_days_of_the_month[]
//
//    }
}